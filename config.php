...
$config->custom->session['blowfish'] = 'd9a2958e5dc5c652dc8376aa63c4bad5';  # Autogenerated for megatron2.localdomain
...
$servers->setValue('server','name','CBDS LDAP Server');
...
$servers->setValue('server','base',array('dc=cbs,dc=nl'));
...
$servers->setValue('login','bind_id','cn=admins,dc=cbs,dc=nl');
